...
class InputMedia(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self.type: str = enum.get_member(
            constants.InputMediaType, media_type, media_type
        )
    ...
    @staticmethod
    def _parse_thumbnail_input(
        thumbnail: Optional[FileInput],
...
class InputPaidMediaVideo(InputPaidMedia):
    ...
    def __init__(
        ...
        *,
        ...
        with self._unfrozen():
            self.thumbnail: Optional[Union[str, InputFile]] = (
                InputMedia._parse_thumbnail_input(thumbnail)
            )
...
class InputMediaAnimation(InputMedia):
    ...
    def __init__(
        ...
        *,
        ...
        with self._unfrozen():
            self.thumbnail: Optional[Union[str, InputFile]] = (
                self._parse_thumbnail_input(thumbnail)
            )
            self.width: Optional[int] = width
            self.height: Optional[int] = height
            self.duration: Optional[int] = duration
