...
class InputStoryContentVideo(InputStoryContent):
    ...
    def __init__(
        ...
        *,
        ...
        with self._unfrozen():
            ...
            self.cover_frame_timestamp: Optional[dtm.timedelta] = (
                self._parse_period_arg(cover_frame_timestamp)
            )
    ...
    @staticmethod
    def _parse_period_arg(
        arg: Optional[Union[float, dtm.timedelta]]
    ) -> Optional[dtm.timedelta]:
        if arg is None:
            return None
