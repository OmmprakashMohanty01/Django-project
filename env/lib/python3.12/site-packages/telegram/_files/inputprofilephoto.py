...
class InputProfilePhotoStatic(InputProfilePhoto):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            type=constants.InputProfilePhotoType.STATIC, api_kwargs=api_kwargs
        )
        with self._unfrozen():
...
class InputProfilePhotoAnimated(InputProfilePhoto):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            type=constants.InputProfilePhotoType.ANIMATED, api_kwargs=api_kwargs
        )
        with self._unfrozen():
            # We use local_mode=True because we don't have access to the actual setting and want
            # things to work in local mode.
            ...
            if isinstance(main_frame_timestamp, dtm.timedelta):
                self.main_frame_timestamp: Optional[dtm.timedelta] = (
