...
class SecureData(TelegramObject):
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "SecureData":
        ...
        data["rental_agreement"] = de_json_optional(
            data.get("rental_agreement"), SecureValue, bot
        )
        data["bank_statement"] = de_json_optional(
            data.get("bank_statement"), SecureValue, bot
        )
        data["utility_bill"] = de_json_optional(
            data.get("utility_bill"), SecureValue, bot
        )
        data["address"] = de_json_optional(data.get("address"), SecureValue, bot)
        data["identity_card"] = de_json_optional(
            data.get("identity_card"), SecureValue, bot
        )
        data["driver_license"] = de_json_optional(
            data.get("driver_license"), SecureValue, bot
        )
        ...
        data["personal_details"] = de_json_optional(
            data.get("personal_details"), SecureValue, bot
        )
...
class SecureValue(TelegramObject):
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "SecureValue":
        ...
        data["front_side"] = de_json_optional(
            data.get("front_side"), FileCredentials, bot
        )
        data["reverse_side"] = de_json_optional(
            data.get("reverse_side"), FileCredentials, bot
        )
        ...
        data["translation"] = de_list_optional(
            data.get("translation"), FileCredentials, bot
        )
