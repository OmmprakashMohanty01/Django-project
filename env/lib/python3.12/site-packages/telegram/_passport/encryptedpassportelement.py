...
class EncryptedPassportElement(TelegramObject):
    ...
    def __init__(
        ...
        data: Optional[
            Union[PersonalDetails, IdDocumentData, ResidentialAddress]
        ] = None,
    ...
    def de_json(
        ...
        data["reverse_side"] = de_json_optional(
            data.get("reverse_side"), PassportFile, bot
        )
        data["selfie"] = de_json_optional(data.get("selfie"), PassportFile, bot)
        data["translation"] = (
            de_list_optional(data.get("translation"), PassportFile, bot) or None
        )
    ...
    def de_json_decrypted(
        ...
        if data["type"] not in ("phone_number", "email"):
            ...
            data["files"] = (
                de_list_decrypted_optional(
                    data.get("files"), PassportFile, bot, secure_data.files
                )
                or None
            )
