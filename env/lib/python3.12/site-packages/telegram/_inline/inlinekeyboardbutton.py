...
class InlineKeyboardButton(TelegramObject):
    ...
    def de_json(
        ...
        data["callback_game"] = de_json_optional(
            data.get("callback_game"), CallbackGame, bot
        )
        data["switch_inline_query_chosen_chat"] = de_json_optional(
            data.get("switch_inline_query_chosen_chat"),
