...
class MessageEntity(TelegramObject):
    ...
    def adjust_message_entities_to_utf_16(text: str, entities: _SEM) -> _SEM:
        ...
        for entity in entities:
            ...
            translated_length = (
                position_translation[entity.offset + entity.length]
    ...
    def shift_entities(by: Union[str, int], entities: _SEM) -> _SEM:
        ...
        """
        effective_shift = (
            by if isinstance(by, int) else len(by.encode("utf-16-le")) // 2
        )
    ...
    EXPANDABLE_BLOCKQUOTE: Final[str] = (
        constants.MessageEntityType.EXPANDABLE_BLOCKQUOTE
    )
