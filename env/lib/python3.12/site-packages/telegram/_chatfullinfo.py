...
class ChatFullInfo(_ChatBase):
    ...
    def __init__(
        ...
        *,
        ...
        if accepted_gift_types is None:
            raise TypeError(
                "`accepted_gift_type` is a required argument since Bot API 9.0"
            )
        ...
        with self._unfrozen():
            ...
            self.emoji_status_custom_emoji_id: Optional[str] = (
                emoji_status_custom_emoji_id
            )
            ...
            self.available_reactions: Optional[tuple[ReactionType, ...]] = (
                parse_sequence_arg(available_reactions)
            )
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "ChatFullInfo":
        ...
        data["pinned_message"] = de_json_optional(
            data.get("pinned_message"), Message, bot
        )
        data["permissions"] = de_json_optional(
            data.get("permissions"), ChatPermissions, bot
        )
        ...
        data["business_intro"] = de_json_optional(
            data.get("business_intro"), BusinessIntro, bot
        )
