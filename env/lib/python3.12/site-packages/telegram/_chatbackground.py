...
class BackgroundFill(TelegramObject):
    ...
    * :class:`telegram.BackgroundFillFreeformGradient`
    ...
    GRADIENT: Final[constants.BackgroundFillType] = (
        constants.BackgroundFillType.GRADIENT
    )
...
class BackgroundType(TelegramObject):
    ...
    * :class:`telegram.BackgroundTypeChatTheme`.
    ...
    WALLPAPER: Final[constants.BackgroundTypeType] = (
        constants.BackgroundTypeType.WALLPAPER
    )
    ...
    CHAT_THEME: Final[constants.BackgroundTypeType] = (
        constants.BackgroundTypeType.CHAT_THEME
    )
