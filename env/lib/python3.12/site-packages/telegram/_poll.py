...
class InputPollOption(TelegramObject):
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "InputPollOption":
        ...
        data["text_entities"] = de_list_optional(
            data.get("text_entities"), MessageEntity, bot
        )
...
class Poll(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self.question_entities: tuple[MessageEntity, ...] = parse_sequence_arg(
            question_entities
        )
    ...
    def parse_explanation_entities(
        ...
        return parse_message_entities(
            self.explanation, self.explanation_entities, types
        )
    ...
    .. versionadded:: 20.0
    """
    MAX_EXPLANATION_LINE_FEEDS: Final[int] = (
