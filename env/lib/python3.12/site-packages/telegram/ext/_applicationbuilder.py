...
class ApplicationBuilder(Generic[BT, CCT, UD, CD, BD, JQ]):
    ...
    def __init__(self: "InitApplicationBuilder"):
        ...
        self._base_file_url: DVType[BaseUrl] = DefaultValue(
        ...
        self._get_updates_proxy: DVInput[Union[str, httpx.Proxy, httpx.URL]] = (
            DEFAULT_NONE
        )
    ...
    def proxy(
        self: BuilderType, proxy: Union[str, httpx.Proxy, httpx.URL]
    ) -> BuilderType:
    ...
    def socket_options(
        self: BuilderType, socket_options: Collection[SocketOpt]
    ) -> BuilderType:
