...
HandledTypes = TypeVar(
    "HandledTypes", bound=Union[Message, CallbackQuery, ChatFullInfo]
)
...
class ExtBot(Bot, Generic[RLARGS]):
    ...
    def _merge_lpo_defaults(
        ...
        if (
            ...
            or (defaults_lpo := self.defaults.link_preview_options) is None
        ):
    ...
    def _replace_keyboard(self, reply_markup: Optional[KT]) -> Optional[KT]:
        ...
        if (
            ...
            and self.callback_data_cache is not None
        ):
