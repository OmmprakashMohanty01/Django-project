...
from telegram._messagereactionupdated import (
...
class Update(TelegramObject):
    ...
    .. versionadded:: 21.1"""
    DELETED_BUSINESS_MESSAGES: Final[str] = (
        constants.UpdateType.DELETED_BUSINESS_MESSAGES
    )
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "Update":
        ...
        data["edited_message"] = de_json_optional(
            data.get("edited_message"), Message, bot
        )
        data["inline_query"] = de_json_optional(
            data.get("inline_query"), InlineQuery, bot
        )
        data["chosen_inline_result"] = de_json_optional(
            data.get("chosen_inline_result"), ChosenInlineResult, bot
        )
        data["callback_query"] = de_json_optional(
            data.get("callback_query"), CallbackQuery, bot
        )
        data["shipping_query"] = de_json_optional(
            data.get("shipping_query"), ShippingQuery, bot
        )
        ...
        data["chat_member"] = de_json_optional(
            data.get("chat_member"), ChatMemberUpdated, bot
        )
        data["chat_join_request"] = de_json_optional(
            data.get("chat_join_request"), ChatJoinRequest, bot
        )
        data["chat_boost"] = de_json_optional(
            data.get("chat_boost"), ChatBoostUpdated, bot
        )
        ...
        data["business_message"] = de_json_optional(
            data.get("business_message"), Message, bot
        )
