...
class UniqueGiftBackdrop(TelegramObject):
    ...
    def de_json(
        ...
        data["colors"] = de_json_optional(
            data.get("colors"), UniqueGiftBackdropColors, bot
        )
...
class UniqueGift(TelegramObject):
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "UniqueGift":
        ...
        data["backdrop"] = de_json_optional(
            data.get("backdrop"), UniqueGiftBackdrop, bot
        )
...
class UniqueGiftInfo(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self.origin: str = enum.get_member(
            constants.UniqueGiftInfoOrigin, origin, origin
        )
        # Optional
