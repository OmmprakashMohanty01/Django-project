...
class StarTransaction(TelegramObject):
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "StarTransaction":
        ...
        data["receiver"] = de_json_optional(
            data.get("receiver"), TransactionPartner, bot
        )
...
class StarTransactions(TelegramObject):
    ...
    def __init__(
        self,
        transactions: Sequence[StarTransaction],
        *,
        api_kwargs: Optional[JSONDict] = None,
    ):
        super().__init__(api_kwargs=api_kwargs)
        self.transactions: tuple[StarTransaction, ...] = parse_sequence_arg(
            transactions
        )
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "StarTransactions":
        ...
        data["transactions"] = de_list_optional(
            data.get("transactions"), StarTransaction, bot
        )
        return super().de_json(data=data, bot=bot)
