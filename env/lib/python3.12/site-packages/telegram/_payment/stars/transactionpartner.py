...
class TransactionPartnerAffiliateProgram(TransactionPartner):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            type=TransactionPartner.AFFILIATE_PROGRAM, api_kwargs=api_kwargs
        )
    ...
    def __init__(
        ...
        *,
        ...
        if transaction_type is None:
            raise TypeError(
                "`transaction_type` is a required argument since Bot API 9.0"
            )
        ...
        with self._unfrozen():
            ...
            self.paid_media: Optional[tuple[PaidMedia, ...]] = parse_sequence_arg(
                paid_media
            )
            ...
            self.gift: Optional[Gift] = gift
            self.premium_subscription_duration: Optional[int] = (
                premium_subscription_duration
            )
...
class TransactionPartnerTelegramApi(TransactionPartner):
    ...
    def __init__(
        self, request_count: int, *, api_kwargs: Optional[JSONDict] = None
    ) -> None:
