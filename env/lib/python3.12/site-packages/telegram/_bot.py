...
class Bot(TelegramObject, contextlib.AbstractAsyncContextManager["Bot"]):
    ...
    async def _send_message(
        ...
        *,
        ...
        if (
            ...
            and reply_parameters is not None
        ):
            raise ValueError(
    ...
    async def send_message(
        ...
        *,
        ...
        link_preview_options = parse_lpo_and_dwpp(
    ...
    async def send_audio(
        ...
        *,
        ...
        data: JSONDict = {
            ...
            "title": title,
            "thumbnail": (
                self._parse_file_input(thumbnail, attach=True) if thumbnail else None
            ),
        }
        ...
        *,
        ...
        result = cast(
            ...
            await self._post(
                ...
                data,
                read_timeout=(
                    arg_read_timeout + timeout if timeout else arg_read_timeout
                ),
                write_timeout=write_timeout,
                connect_timeout=connect_timeout,
                pool_timeout=pool_timeout,
        ...
        try:
            ...
            self._LOGGER.critical(
                "Error while parsing updates! Received data was %r",
                result,
                exc_info=exc,
            )
            raise
    ...
    async def replace_sticker_in_set(
        ...
        *,
        ...
        data: JSONDict = {
            ...
            "name": name,
            "old_sticker": (
                old_sticker if isinstance(old_sticker, str) else old_sticker.file_id
            ),
            "sticker": sticker,
        }
