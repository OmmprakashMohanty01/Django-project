...
class InaccessibleMessage(MaybeInaccessibleMessage):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            chat=chat, message_id=message_id, date=ZERO_DATE, api_kwargs=api_kwargs
        )
        self._freeze()
...
class Message(MaybeInaccessibleMessage):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            chat=chat, message_id=message_id, date=date, api_kwargs=api_kwargs
        )
        ...
        with self._unfrozen():
            ...
            self.video_chat_scheduled: Optional[VideoChatScheduled] = (
                video_chat_scheduled
            )
            ...
            self.forum_topic_reopened: Optional[ForumTopicReopened] = (
                forum_topic_reopened
            )
            ...
            self.write_access_allowed: Optional[WriteAccessAllowed] = (
                write_access_allowed
            )
    ...
    def de_json(cls, data: JSONDict, bot: Optional["Bot"] = None) -> "Message":
        ...
        data["reply_to_message"] = de_json_optional(
            data.get("reply_to_message"), Message, bot
        )
        ...
        data["new_chat_members"] = de_list_optional(
            data.get("new_chat_members"), User, bot
        )
        data["left_chat_member"] = de_json_optional(
            data.get("left_chat_member"), User, bot
        )
        data["new_chat_photo"] = de_list_optional(
            data.get("new_chat_photo"), PhotoSize, bot
        )
        ...
        data["passport_data"] = de_json_optional(
            data.get("passport_data"), PassportData, bot
        )
        ...
        data["web_app_data"] = de_json_optional(
            data.get("web_app_data"), WebAppData, bot
        )
        ...
        data["users_shared"] = de_json_optional(
            data.get("users_shared"), UsersShared, bot
        )
        ...
        data["paid_media"] = de_json_optional(
            data.get("paid_media"), PaidMediaInfo, bot
        )
        ...
        data["unique_gift"] = de_json_optional(
            data.get("unique_gift"), UniqueGiftInfo, bot
        )
        ...
        data["forward_origin"] = de_json_optional(
            data.get("forward_origin"), MessageOrigin, bot
        )
        data["reply_to_story"] = de_json_optional(
            data.get("reply_to_story"), Story, bot
        )
        data["boost_added"] = de_json_optional(
            data.get("boost_added"), ChatBoostAdded, bot
        )
        data["sender_business_bot"] = de_json_optional(
            data.get("sender_business_bot"), User, bot
        )
    ...
    def compute_quote_position_and_entities(
        ...
        for entity in self.entities or self.caption_entities:
            if (
                ...
                and entity.offset <= end_position
            ):
    ...
    def build_reply_arguments(
        ...
        Returns:
            :obj:`dict`:
        """
        target_chat_is_self = target_chat_id in (
            None,
            self.chat_id,
        ...
        quote_position, quote_entities = (
            self.compute_quote_position_and_entities(quote, quote_index)
            if quote
            else (None, None)
        )
    ...
    def _parse_message_thread_id(
        ...
        return (
            self.message_thread_id
            if chat_id in {self.chat_id, self.chat.username}
            else None
        )
    ...
    async def reply_chat_action(
        ...
        *,
        ...
        return await self.get_bot().send_chat_action(
            ...
            message_thread_id=self._parse_message_thread_id(
        ...
        if version == 1:
            for entity_type in (
                ...
                if any(entity.type == entity_type for entity in entities):
                    name = entity_type.name.title().replace(
                        "_", " "
                    )  # type:ignore[attr-defined]
                    raise ValueError(
                        f"{name} entities are not supported for Markdown version 1"
                    )
